              ...
              <form action="" method="post">
                <div class="flex flex-col space-y-16">
                  ...
                  <div class="flex flex-col space-y-5">
                    <div>
                      <a :href="$router.resolve({name: 'setup_password'}).href" class="flex flex-row items-center justify-center text-center w-full border rounded-xl outline-none py-5 bg-blue-700 border-none text-white text-sm shadow-sm">
                       Verifikasi Akun
                      </a>
                    </div>
      
                    <div class="flex flex-row items-center justify-center text-center text-sm font-medium space-x-1 text-gray-500">
                      <p>Belum Mendapatkan Kode ?</p> <a class="flex flex-row items-center text-blue-600" href="http://" target="_blank" rel="noopener noreferrer">Resend</a>
                    </div>
                  </div>
                </div>
              </form>
